...
#ifndef TABLEKIT_SWIFT_H
#define TABLEKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TableKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8TableKit13TableDirector")
@interface TableDirector : NSObject <UITableViewDataSource, UITableViewDelegate>
...
- (BOOL)tableView:(UITableView * _Nonnull)tableView shouldBeginMultipleSelectionInteractionAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=13.0);
- (void)tableView:(UITableView * _Nonnull)tableView didBeginMultipleSelectionInteractionAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_AVAILABILITY(ios,introduced=13.0);
